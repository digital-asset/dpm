...
// ReplaceList replaces the entire list at field with items.
func ReplaceList(raw []byte, field string, items []string) (string, error) {
	return ReplaceListAny(raw, field, items)
}
