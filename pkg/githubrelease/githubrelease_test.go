...
func TestListDarAssets_andDownload(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch {
		case strings.Contains(r.URL.Path, "/repos/digital-asset/daml-finance/releases/tags/"):
		...
		case r.URL.EscapedPath() == "/digital-asset/daml-finance/releases/download/"+url.PathEscape(tag)+"/"+url.PathEscape(asset):
			_, _ = w.Write(darBody)
		default:
			http.NotFound(w, r)
		}
